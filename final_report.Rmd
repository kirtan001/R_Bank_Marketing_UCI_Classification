...
This pipeline automatically runs tests and builds the Docker image whenever code is pushed to GitHub.
...
The Plumber API exposes the trained model as a REST service. It provides a health endpoint and a prediction endpoint for real-time inference.
